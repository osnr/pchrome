export declare namespace accessibilityFeatures {
...
export declare namespace browser {
     ...
     */
    export function openTab(options: Options): Promise<void>;
...
export declare namespace bookmarks {
	 ...
	 * function() {...};
	 */
    export function removeTree(id: string): Promise<any>;
...
export declare namespace browserAction {
	 ...
	 * function() {...};
	 */
    export function setIcon(details: TabIconDetails): Promise<any>;
...
export declare namespace contentSettings {
...
export declare namespace cookies {
	 ...
	 */
    export function get(details: Details): Promise<Cookie>;
...
export declare namespace debugger_ {
...
export declare namespace declarativeContent {
...
export declare namespace declarativeWebRequest {
...
export declare namespace desktopCapture {
...
export declare namespace devtools.inspectedWindow {
	 ...
	 */
    export function eval_(expression: string): Promise<[Object, EvaluationExceptionInfo]>;
...
export declare namespace devtools.network {
...
export declare namespace devtools.panels {
	 ...
	 */
    export function setOpenResourceHandler(): Promise<chrome.devtools.inspectedWindow.Resource>;
...
export declare namespace documentScan {
...
export declare namespace enterprise.platformKeys {
...
export declare namespace fileBrowserHandler {
...
export declare namespace fileSystemProvider {
...
export declare namespace fontSettings {
	 ...
	 * function() {...};
	 */
    export function setDefaultFontSize(details: DefaultFontSizeDetails): Promise<any>;
	 ...
	 * function() {...};
	 */
    export function setMinimumFontSize(details: SetFontSizeDetails): Promise<any>;
	 ...
	 * function() {...};
	 */
    export function clearDefaultFontSize(details?: Object): Promise<any>;
	 ...
	 * function() {...};
	 */
    export function setDefaultFixedFontSize(details: SetFontSizeDetails): Promise<any>;
	 ...
	 * function() {...};
	 */
    export function clearFont(details: FontDetails): Promise<any>;
	 ...
	 * function(object details) {...};
	 */
    export function setFont(details: SetFontDetails): Promise<any>;
	 ...
	 * function() {...};
	 */
    export function clearMinimumFontSize(details?: Object): Promise<any>;
	 ...
	 * function() {...};
	 */
    export function clearDefaultFixedFontSize(details: Object): Promise<any>;
...
export declare namespace input.ime {
	 ...
	 * function() {...};
	 */
	export function setMenuItems(parameters: ImeParameters): Promise<void>;
	 ...
	 * function() {...};
	 */
	export function updateMenuItems(parameters: MenuItemParameters): Promise<void>;
...
export declare namespace networking.config {
	 ...
	 * function() {...};
	 */
	export function setNetworkFilter(networks: NetworkInfo[]): Promise<void>;
	 ...
	 * function() {...};
	 */
	export function finishAuthentication(GUID: string, result: string): Promise<void>;
...
export declare namespace pageCapture {
...
export declare namespace platformKeys {
	 ...
	 */
	export function getKeyPair(certificate: ArrayBuffer, parameters: Object): Promise<[CryptoKey, CryptoKey]>;
...
export declare namespace printerProvider {
...
export declare namespace runtime {
     ...
     */
    export function requestUpdateCheck(): Promise<[string, UpdateCheckDetails]>;
...
export declare namespace scriptBadge {
    ...
    export function getPopup(details: GetPopupDetails): Promise<any>;
...
export declare namespace system.cpu {
...
export declare namespace system.memory {
...
export declare namespace system.storage {
...
export declare namespace tabCapture {
	 ...
	 */
    export function capture(options: CaptureOptions): Promise<MediaStream>;
...
export declare namespace tabs {
	 ...
	 */
    export function remove(tabId: number): Promise<any>;

	/**
	 * Closes several tabs.
	 * @param tabIds The list of tabs to close.
	 */
    export function remove(tabIds: number[]): Promise<any>;
	 ...
	 */
	export function insertCSS(details: InjectDetails): Promise<any>;
	 ...
	 * @param callback Optional. Called when all the CSS has been inserted.
	 */
    export function insertCSS(tabId: number, details: InjectDetails): Promise<any>;
...
export declare namespace tts {
	 ...
	 */
	export function speak(utterance: string): Promise<any>;
	 ...
	 * @param callback Optional. Called right away, before speech finishes. Check chrome.runtime.lastError to make sure there were no errors. Use options.onEvent to get more detailed feedback.
	 */
	export function speak(utterance: string, options: SpeakOptions): Promise<any>;
...
export declare namespace ttsEngine {
...
export declare namespace vpnProvider {
	 ...
	 */
	export function destroyConfig(id: string): Promise<any>;
	 ...
	 */
	export function setParameters(parameters: VpnSessionParameters): Promise<any>;
	 ...
	 */
	export function sendPacket(data: ArrayBuffer): Promise<any>;
	 ...
	 */
	export function notifyConnectionStateChanged(state: string): Promise<any>;
...
export declare namespace webNavigation {
	 ...
	 */
    export function getFrame(details: GetFrameDetails): Promise<GetFrameResultDetails>;
	 ...
	 */
    export function getAllFrames(details: GetAllFrameDetails): Promise<GetAllFrameResultDetails[]>;
...
export declare namespace webRequest {
    ...
    export function handlerBehaviorChanged(): Promise<any>;
...
export declare namespace webstore {
	 ...
	 * * * "launchInProgress": A launch of the same extension is in progress.
	 */
	export function install(): Promise<[string, string]>;
...
export declare namespace windows {
	 ...
	 * @since Chrome 18.
	 */
    export function get(windowId: number, getInfo: GetInfo): Promise<chrome.windows.Window>;
	 ...
	 * @since Chrome 18.
	 */
    export function getCurrent(getInfo: GetInfo): Promise<chrome.windows.Window>;
	 ...
	 * @since Chrome 18.
	 */
    export function getAll(getInfo: GetInfo): Promise<chrome.windows.Window[]>;
    ...
    export function remove(windowId: number): Promise<any>;
	 ...
	 * @since Chrome 18.
	 */
    export function getLastFocused(getInfo: GetInfo): Promise<chrome.windows.Window>;
